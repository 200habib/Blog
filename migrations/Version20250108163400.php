 ...
 */
final class Version20250108163400 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_profile ADD CONSTRAINT FK_D95AB40518F45C82 FOREIGN KEY (website_id) REFERENCES website (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
